    ...
    <div class="box">
      <div class="box__ghost">
        ...
        <div class="box__ghost-container">
          <div class="box__ghost-eyes" ref='ghosteyes' :style="`transform: ${transform}`">
      ...
      <div class="box__description">
        ...
        <a class="box__button" @click.prevent="router.push('/')">返回</a>
...
export default {
  ...
  setup() {
    ...
    document.onmousemove = event => {
      ...
      Axis.y = ((pageY / 2 - mouseY) / pageY) * 300
      mouseX = event.screenX / -pageX
      Axis.x = -mouseX * 100 - 100
      console.log(Axis)

      if (Axis.y > 0) {
        transform.value = 'translate(' + Axis.x + '%,-' + Axis.y + '%)'
      }
    }
